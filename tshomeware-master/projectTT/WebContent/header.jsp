...
$(document).ready(function(){
   ...
   function runScript(e) {
	    ...
	    if (e.keyCode == 13) {
	    	var flag=0;
	        //var tb = document.getElementById("text-Search");
	        var textSearch = $("#text-Search").val()
	        //alert(textSearch);
	        if(textSearch.trim()==''){
	        	alert("Không để trống ô tìm kiếm")
...
<body>
    ...
    <input type="text" id= "text-Search" name="textSearch" onkeypress="return runScript(event)" class="form-control" style="width:120%; border-radius:15px; border:2px solid #219AFC; padding:18px 15px;position:relative" type="text" placeholder="Tìm kiếm...">
