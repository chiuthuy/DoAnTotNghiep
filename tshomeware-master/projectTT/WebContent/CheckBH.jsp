	...
	<section style="margin-top: 0" id="page-content">
        ...
        <div class="container">
            ...
            <div class="center-content">
                <h3>TRUNG TÂM BẢO HÀNH TH-HOMEWARE</h3>
                <p>Tất cả trung tâm bảo hành ủy quyền TH-HOMEWARE trên toàn quốc đều được đào tạo và chỉ sử dụng linh kiện chính hãng TH-HOMEWARE trong mọi hoạt động sửa chữa.</p>
    ...
    <div class="modal-dialog">
		         ...
		         <!--      <span onclick="document.getElementById('id03').style.display='none'" class="close" title="Close Modal">&times;</span> -->
		            ...
		            <div id="poo1" class="container-12">
		            	...
		            	<p style="text-align:center">Cảm ơn quý khách đã sử dụng sản phẩm của <span style="color:red">TH-HOMEWARE</span>.
