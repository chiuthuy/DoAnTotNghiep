										...
										<form action="/TH_Homeware/ProductServlet_Update" method="post">
											...
											<div class="form-group">
											 ...
											 <div class="form-group">											
												...
												<select class="form-control" name="Danh_Muc" value="<%=request.getParameter("Danh_Muc") %>">
													<%
											...
											<div class="form-group">
												...
												<textarea class="form-control" type="text" name="Describe" rows="4" cols="50" value="<%=request.getParameter("Describe")%>" ><%=request.getParameter("Describe")%></textarea>
											</div>
											<div class="form-group">
												<label>Giá bán</label> 
